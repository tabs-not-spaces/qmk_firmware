...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY] = LAYOUT_ortho_5x12(
        ...
        RGB_TOG,    KC_LCTL, KC_LALT,   KC_LGUI,    MO(_LOWER), KC_SPC, KC_SPC, MO(_RAISE), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
	...
	[_LOWER] = LAYOUT_ortho_5x12(
        ...
        RGB_MOD,      _______,    _______,    _______,    _______,    _______, _______, MO(_ADJUST),   KC_MNXT,       LCA(KC_DOWN), LCA(KC_UP), KC_MPLY
    ),
	...
	[_RAISE] = LAYOUT_ortho_5x12(
        ...
        RGB_RMOD, _______, _______, _______, MO(_ADJUST), _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
    ),
